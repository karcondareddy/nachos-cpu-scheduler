...
// advance simulated time
    ...
    // ----- ADDED FOR HRRN: increment waiting time of all ready threads -----
    // This requires a new method in Scheduler. Implement in scheduler.cc:
    // void Scheduler::IncrementWaitingTimes() { ... iterate over ready list(s) ... }
